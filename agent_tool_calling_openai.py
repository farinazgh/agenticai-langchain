...
@tool(description="Look up the price of a product in the catalog.")
...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        print(f"\n  [LLM LATENCY] {round(end - start, 2)} seconds")
        ...
        if call_signature in seen_calls:
            print("  [WARNING] Repeated tool call detected — possible loop")
        else:
...
if __name__ == "__main__":
    print("Hello LangChain Agent (.bind_tools) with OpenAI!")
    print()
